        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    {{-- 店の詳細ボタン --}}
                    <div class="mb-4 text-center">
                        <a href='javascript:;' class="py-2 px-4 bg-gray-200" data-micromodal-trigger="modal-1" type="button" class="text-white bg-gray-400 border-0 py-2 px-6 focus:outline-none hover:bg-gray-500 rounded">ショップの詳細を見る</a>
                    </div>
                </div>
            </div>
        </div>
